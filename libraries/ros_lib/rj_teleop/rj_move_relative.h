#ifndef _ROS_SERVICE_rj_move_relative_h
#define _ROS_SERVICE_rj_move_relative_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char RJ_MOVE_RELATIVE[] = "rj_teleop/rj_move_relative";

  class rj_move_relativeRequest : public ros::Msg
  {
    public:
      float linear;
      float angular;

    rj_move_relativeRequest():
      linear(0),
      angular(0)
    {
    }
    ...
    const char * getType(){ return RJ_MOVE_RELATIVE; };
    const char * getMD5(){ return "9d5c2dcd348ac8f76ce2a4307bd63a13"; };

  };

  class rj_move_relativeResponse : public ros::Msg
  {
    public:

    rj_move_relativeResponse()
    {
    }
  ...
  class rj_move_relative {
    public:
    typedef rj_move_relativeRequest Request;
    typedef rj_move_relativeResponse Response;
  };
